                ...
                revapi1 = tpj("#rev_slider_1_1").show().revolution({
                    ...
                    navigation: {
                        ...
                        tabs: {
                            ...
                            tmp: '<div class="tp-tab-content">  <span class="tp-tab-date">{{param1}}</span>  <span class="tp-tab-title">{{title}}</span></div><div class="tp-bullet-number">',
                            visibleAmount: 3,
                            hide_onmobile: true,
                            hide_under: 991.98,
                            hide_onleave: false,
...
//Click event to scroll to top
    const countUp = new CountUp('service-num-01', 5234);
    if (!countUp.error) {
    countUp.start();
    } else {
